...
/**
 * <b>Descrição:</b><br>
 * Representa o DTO (Data Transfer Object) da Editora, utilizado para
 * transporte de dados entre as camadas da aplicação e exposição em
 * APIs sem acoplar diretamente a entidade de domínio.
 *
 * <p>
 * Esta classe encapsula as informações essenciais de uma editora,
 ...
 * <h3>Campos</h3>
 * <ul>
 *     <li><b>id</b> — Identificador único da editora</li>
 *     <li><b>name</b> — Nome completo da editora</li>
 * </ul>
 *
 * <h3>Recursos</h3>
 * <ul>
